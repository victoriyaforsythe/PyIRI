...
class TestIGRFLibUtil(object):
    ...
    def setup_method(self):
        ...
        self.alt_in = 300.
        self.date_in = datetime.datetime(2020, 10, 1)
...
class TestIGRFLibCoeff(object):
    ...
    def teardown(self):
        ...
        del self.date_in, self.lon_in, self.lat_in, self.alt_in, self.coeff_in
        del self.inc_out, self.brad_out, self.btheta_out, self.bphi_out
        del self.test_out
        return
